...
if ( $nm_globals['shop_search_header'] ) {
    ...
    $default_links['search'] = sprintf(
        '<li class="nm-menu-search menu-item-default has-icon"><a href="#" id="nm-menu-search-btn">%s</a></li>',
        $search_icon_html
    );
}
...
if ( $nm_globals['wishlist_enabled'] && $nm_theme_options['menu_wishlist'] ) {
    ...
    $default_links['wishlist'] = sprintf(
        '<li class="nm-menu-wishlist menu-item-default %s">%s</li>',
        esc_attr( $icon_class ),
...
if ( nm_woocommerce_activated() && $nm_theme_options['menu_login'] ) {
    ...
    $default_links['my_account'] = sprintf(
        '<li class="nm-menu-account menu-item-default %s">%s</li>',
        esc_attr( $icon_class ),
